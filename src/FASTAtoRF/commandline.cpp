...
static s_command_parameter _command_parameters[] = {
	{	"Input FASTA file",
		"-fasta", _TYPE_STRING, true, false, 0, 0.0, "None" },
	{	"Randomize ZF sequences",
		"-rnd", _TYPE_INT, true, true, 0, 0.0, "None" },
	{	"The zinc-finger span for each motif",
		"-span", _TYPE_INT, true, true, 0, 0.0, "None" },
	{	"The minimum linker length between two ZFs",
		"-minl", _TYPE_INT, true, true, 4, 0.0, "None" },
	{	"The maximum linker length between two ZFs",
		"-maxl", _TYPE_INT, true, true, 6, 0.0, "None" },
	{	"Output file",
		"-out"  , _TYPE_STRING, true, false, 0, 0.0, "None" } };

int _num_parameters = 6;

const char *__FASTA_file = _command_parameters[ 0 ].v_string;
const int *__rnd = & _command_parameters[ 1 ].v_int;
const int *__span = & _command_parameters[ 2 ].v_int;
const int *__minl = & _command_parameters[ 3 ].v_int;
const int *__maxl = & _command_parameters[ 4 ].v_int;
const char *__output_file = _command_parameters[ 5 ].v_string;
