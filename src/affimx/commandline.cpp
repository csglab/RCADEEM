...
static s_command_parameter _command_parameters[] = {
	{	"Input PWM file",
		"-pwm", _TYPE_STRING, true, false, 0, 0.0, "" },
	{	"Input FASTA file",
		"-fasta", _TYPE_STRING, true, false, 0, 0.0, "" },
	{	"The direction for scanning (0: forward-only; 1: reverese-only; 2: both)",
		"-dir", _TYPE_INT, true, true, 2, 0.0, "" },
	{	"Whether motif columns or gene sequences should be shuffled (0: shuffle none; 1: shuffle motifs; 2: shuffle genes)",
		"-rnd", _TYPE_INT, true, true, 0, 0.0, "" },
	{	"Output file",
		"-out"  , _TYPE_STRING, true, false, 0, 0.0, "" } };

int _num_parameters = 5;

const char *__PWM_file		=  _command_parameters[ 0 ].v_string;
const char *__FASTA_file	=  _command_parameters[ 1 ].v_string;
const int *__direction		= &_command_parameters[ 2 ].v_int;
const int *__shuffle		= &_command_parameters[ 3 ].v_int;
